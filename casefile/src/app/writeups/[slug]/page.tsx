...
export function generateStaticParams() {
  // Drafts are excluded by default, so no static page is even generated
  // for them — visiting a draft's URL 404s until it's published.
...
export default async function WriteupPage({
  ...
  const { html, toc } = await markdownToHtml(writeup.content);
